                    ...
                    function updateConfiguration() {
                        ...
                        if (scope.features) {
                            if (scope.features.xAxis) {
                                ...
                                if (!xAxis) {
                                	//console.log('xAxisConfig',xAxisConfig)
                            ...
                            if (scope.features.legend) {
                            	...
                            	//console.log('legendEl',legendEl);
                            	var legendParent=document.getElementById('legend');
                            	legendParent.innerHTML="";
                                if (!legendEl) {
                                    legendEl = $compile('<div style= "z-index:2000;" ui-draggable="true" drag="legend" drag-channel="A" drop-channel="A" on-drop-success="vm.dropSuccessHandler($event,target)"></div>')(scope);
                                    jQuery(legendParent).append(legendEl);
