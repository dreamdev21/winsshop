...
! function(e) {
    ...
    return function t(e, n, r) {
        ...
        2: [function(e, t, n) {
            ...
            n = t.exports = e(3), n.log = i, n.formatArgs = o, n.save = a, n.load = s, n.useColors = r, n.storage = "undefined" != typeof chrome && "undefined" != typeof chrome.storage ? chrome.storage.local : u(), n.colors = ["lightseagreen", "forestgreen", "goldenrod", "dodgerblue", "darkorchid", "crimson"], n.formatters.j = function(e) {
        ...
        7: [function(e, t, n) {
            (function(e) {
                ...
                var t = Array.prototype.slice,
                    ...
                    r = function(e) {
                        if ("object" != typeof e) throw e + " is not an object";
        ...
        8: [function(e, t, n) {
            ...
            t.exports = n = o, o.prototype["catch"] = function(e) {
                ...
                if ("function" != typeof e && this.state === _ || "function" != typeof t && this.state === y) return this;
        ...
        10: [function(e, t, n) {
            ...
            function u(e, t) {
                for (var r = Object.keys(e), o = Object.keys(t), i = Math.min(r.length, o.length), a = 0; i > a; a++) {
                    var s = n.collate(r[a], o[a]);
                    if (0 !== s) return s;
                    if (s = n.collate(e[r[a]], t[o[a]]), 0 !== s) return s
                }
        ...
        12: [function(e, t, n) {
            ...
            function o(e) {
                if (this.store = new r, e && Array.isArray(e))
                    for (var t = 0, n = e.length; n > t; t++) this.add(e[t])
            }
        ...
        14: [function(e, t, n) {
            (function() {
                ...
                t.exports = function(t, r) {
                    ...
                    return Function.apply(null, n.call(i).concat([t])).apply(r["this"], s)
                }
            }).call(this)
        }, {}],
        15: [function(t, n, r) {
        ...
        16: [function(e, t, n) {
            ...
            n.stringify = function(e) {
                ...
                for (var t, n, o, i, a, s, u, c, f, l = [], d = [], h = 0;;)
        ...
        17: [function(e, t, n) {
            (function(n, r) {
                ...
                function a() {
                    for (var e = {}, t = new or(function(t, n) {
                ...
                function y(e) {
                    if (e instanceof ArrayBuffer) return v(e);
                    var t = e.size,
                        n = e.type;
                ...
                function g(e, t) {
                    ...
                    return e = Kn.extend(o, e), e.json && (e.binary || (e.headers.Accept = "application/json"), e.headers["Content-Type"] = e.headers["Content-Type"] || "application/json"), e.binary && (e.encoding = null, e.json = !1), e.processData || (e.json = !1), f(e, function(o, i, a) {
                        if (o) return o.status = i ? i.statusCode : 400, r(o, t);
                        var s, u = i.headers && i.headers["content-type"],
                            c = a || m();
                        if (!e.binary && (e.json || !e.processData) && "object" != typeof c && (/json/.test(u) || /^[\s]*\{/.test(c) && /\}[\s]*$/.test(c))) try {
                    ...
                    function n(e, t, n) {
                        if (Ir.enabled) {
                            ...
                            n[n.length - 1] = function(n, r) {
                                var o = [e._db_name, t];
                                o = o.concat(n ? ["error", n] : ["success", r]), Ir.apply(null, o), i(n, r)
                            }
                        }
                    }
                    return E(Qn(function(r) {
                        if (this._closed) return or.reject(new Error("database is closed"));
                        var o = this;
                ...
                function A(e) {
                    for (var t, n, r, o, i = e.rev_tree.slice(); o = i.pop();) {
                        var a = o.ids,
                            ...
                            u = o.pos;
                        if (s.length)
                            for (var c = 0, f = s.length; f > c; c++) i.push({
                                pos: u + 1,
                                ids: s[c]
                            });
                        else {
                ...
                function O(e, t) {
                    t || (t = A(e));
                    for (var n, r = t.substring(t.indexOf("-") + 1), o = e.rev_tree.map(T); n = o.pop();) {
                ...
                function C(e) {
                    return new Function("doc", ["var emitted = false;", "var emit = function (a, b) {", "  emitted = true;", "};", "var view = " + e + ";", "view(doc);", "if (emitted) {", "  return true;", "}"].join("\n"))
                }
                ...
                function R(e, t) {
                    for (var n, r = e.slice(); n = r.pop();)
                        for (var o = n.pos, i = n.ids, a = i[2], s = t(0 === a.length, o, i[0], n.ctx, i[1]), u = 0, c = a.length; c > u; u++) r.push({
                            pos: o + 1,
                            ids: a[u],
                            ctx: s
                        })
                ...
                function N(e) {
                    ...
                    for (var n = 0, r = t.length; r > n; n++) delete t[n].pos;
                    return t
                }

                function B(e) {
                    for (var t = A(e), n = N(e.rev_tree), r = [], o = 0, i = n.length; i > o; o++) {
                        var a = n[o];
                ...
                function U(e, t, n) {
                    ...
                    a.forEach(function(e) {
                        e.id in s ? s[e.id].push(e) : s[e.id] = [e]
                    });
                    ...
                    Object.keys(s).forEach(function(n, r) {
                        var o = s[n],
                            a = k(o[0], ["atts_since", "attachments"]);
                ...
                function G(e) {
                    var t;
                    if (e ? "string" != typeof e ? t = d(fr) : /^_/.test(e) && !/^_(design|local)/.test(e) && (t = d(dr)) : t = d(lr), t) throw t
                }

                function V(e) {
                    if (!/^\d+\-./.test(e)) return d(xr);
                    var t = e.indexOf("-"),
                        n = e.substring(0, t),
                        r = e.substring(t + 1);
                    return {
                ...
                function X(e, t) {
                    for (var n = e.start - e.ids.length + 1, r = e.ids, o = [r[0], t, []], i = 1, a = r.length; a > i; i++) o = [r[i], {
                            status: "missing"
                        },
                        [o]
                    ];
                ...
                function z(e, t) {
                    ...
                    if (e._deleted && (i.deleted = !0), t)
                        if (e._id || (e._id = J()), r = J(32, 16).toLowerCase(), e._rev) {
                            if (o = V(e._rev), o.error) return o;
                            e._rev_tree = [{
                                pos: o.prefix,
                                ids: [o.id, {
                                        status: "missing"
                    ...
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (n._deleted) delete n._attachments;
                            ...
                            for (var r = Object.keys(n._attachments), o = 0; o < r.length; o++) {
                                var i = r[o];
                                n._attachments[i] = k(n._attachments[i], ["data", "digest", "content_type", "length", "revpos", "stub"])
                            }
                    }
                }
                ...
                function ce(e, t, n) {
                    ...
                    var i = new or(function(o, i) {
                        ...
                        return function() {
                            try {
                                if ("string" != typeof u) throw s = new Error("Missing/invalid DB name"), s.code = 400, s;
                                if (a = ce.parseAdapter(u, t), t.originalName = u, t.name = a.name, t.prefix && "http" !== a.adapter && "https" !== a.adapter && (t.name = t.prefix + t.name), t.adapter = t.adapter || a.adapter, r._adapter = t.adapter, $n("pouchdb:adapter")("Picked adapter: " + t.adapter), r._db_name = u, !ce.adapters[t.adapter]) throw s = new Error("Adapter is missing"), s.code = 404, s;
                                if (!ce.adapters[t.adapter].valid()) throw s = new Error("Invalid Adapter"), s.code = 404, s
                            } catch (e) {
                                r.taskqueue.fail(e)
                            }
                ...
                function ge(e, t, n, r, o) {
                    return e.get(t)["catch"](function(n) {
                        if (404 === n.status) return "http" === e.type() && me(404, "PouchDB is just checking if a remote checkpoint exists."), {
                            session_id: r,
                            _id: t,
                            history: [],
                            replicator: Qr,
                        ...
                        return o.cancelled ? void 0 : (i.history = (i.history || []).filter(function(e) {
                            ...
                            if (409 === i.status) return ge(e, t, n, r, o);
                            throw i
                        }))
                    })
                }
                ...
                function Ce(e, t, n) {
                    var r = n.doc_ids ? n.doc_ids.sort(Yn.collate) : "",
                        ...
                        i = "",
                        a = "";
                    return n.filter && n.query_params && (i = JSON.stringify(je(n.query_params))), n.filter && "_view" === n.filter && (a = n.view.toString()), or.all([e.id(), t.id()]).then(function(e) {
                ...
                function De(e, t, n, r, o) {
                    ...
                    function a() {
                        if (N = [], 0 !== w.docs.length) {
                            ...
                            return t.bulkDocs({
                                ...
                                if (r.cancelled) throw h(), new Error("cancelled");
                                var n = [],
                                    i = {};
                    ...
                    function s() {
                        ...
                        return N.length && (e.docs = N, r.emit("change", e)), x = !0, S.writeCheckpoint(w.seq, B).then(function() {
                            if (x = !1, r.cancelled) throw h(), new Error("cancelled");
                            w = void 0, m()
                        })["catch"](function(e) {
                    ...
                    function h() {
                        if (!(T || r.cancelled && (o.status = "cancelled", x))) {
                            ...
                            } else o.errors = D, r.emit("complete", o), r.removeAllListeners()
                        }
                    }

                    function p(e) {
                        if (r.cancelled) return h();
                        var t = _e(n)(e);
                ...
                function Fe(e, t, n, r) {
                    if ("function" == typeof n && (r = n, n = {}), "undefined" == typeof n && (n = {}), n.doc_ids && !Array.isArray(n.doc_ids)) throw d(gr, "`doc_ids` filter parameter is not a list.");
                ...
                function Ue(e, t, n, r) {
                    ...
                    var _ = or.all([this.push, this.pull]).then(function(e) {
                        var t = {
                            push: e[0],
                            pull: e[1]
                        };
                        ...
                        if (h.cancel(), r ? r(e) : h.emit("error", e), h.removeAllListeners(), r) throw e
                    });
                ...
                function We(e, t) {
                    if ("undefined" == typeof FileReader) return t(He((new FileReaderSync).readAsArrayBuffer(e)));
                    var n = new FileReader,
                ...
                function Ze(e, t) {
                    ...
                    function i() {
                        if (e.skipSetup || e.skip_setup) return or.resolve();
                        if (v) return v;
                        var t = {
                            method: "GET",
                            url: f
                    ...
                    setTimeout(function() {
                        ...
                        function o() {
                            ...
                            for (var r = so, o = Math.ceil(e.docs.length / r), a = 0, s = new Array(o), u = 0; o > u; u++) {
                                var c = k(e, ["revs", "attachments"]);
                        ...
                        e = _(e), e.timeout = "timeout" in e ? e.timeout : "timeout" in l ? l.timeout : 3e4;
                        var r, o = e.timeout ? {
                ...
                function pt(e) {
                    for (var t = 0, n = 0, r = e.length; r > n; n++) {
                        var o = e[n];
                        if ("number" != typeof o) {
                            if (!Array.isArray(o)) throw ht("_sum");
                            t = "number" == typeof t ? [t] : t;
                            for (var i = 0, a = o.length; a > i; i++) {
                                var s = o[i];
                                if ("number" != typeof s) throw ht("_sum");
                ...
                function mt(e) {
                    if (e) {
                        if ("number" != typeof e) return new Dt('Invalid value for integer: "' + e + '"');
                        if (0 > e) return new Dt('Invalid value for positive integer: "' + e + '"')
                    }
                }
                ...
                function gt(e, t) {
                    ...
                    if ("undefined" != typeof e[n] && "undefined" != typeof e[r] && go(e[n], e[r]) > 0) throw new Dt("No rows can match your key range, reverse your start_key and end_key or set {descending : true}");
                    if (t.reduce && e.reduce !== !1) {
                        if (e.include_docs) throw new Dt("{include_docs:true} is invalid for reduce");
                        if (e.keys && e.keys.length > 1 && !e.group && !e.group_level) throw new Dt("Multi-key fetches for reduce views must use {group: true}")
                ...
                function Tt(e) {
                    ...
                    } else i = rt(e.mapFun.toString(), t, pt, mo, Array.isArray, JSON.parse);
                    var s = e.seq || 0,
                        u = new et;
                    return new or(function(t, a) {
                        ...
                        function f() {
                            ...
                            e.sourceDB.changes({
                                ...
                                for (var l = {}, d = 0, h = a.length; h > d; d++) {
                                    var p = a[d];
                                    if ("_" !== p.doc._id[0]) {
                                        r = [], o = p.doc, o._deleted || st(e.sourceDB, i, [o]), r.sort(ut);
                                        for (var v, y = {}, _ = 0, m = r.length; m > _; _++) {
                                            var g = r[_],
                                                b = [g.key, g.id];
                ...
                function Ot(e, t, n) {
                    ...
                    t.forEach(function(e) {
                        var t = i[i.length - 1],
                            n = o ? e.key : null;
                        return o && Array.isArray(n) && "number" == typeof a && (n = n.length > a ? n.slice(0, a) : n), t && 0 === go(t.key[0][0], n) ? (t.key.push([n, e.id]), void t.value.push(e.value)) : void i.push({
                            key: [
                                [n, e.id]
                            ],
                            value: [e.value]
                    ...
                    for (var s = 0, u = i.length; u > s; s++) {
                        var c = i[s],
                            f = st(e.sourceDB, r, [c.key, c.value, !1]);
                        if (f.error && f.error instanceof Bt) throw f.error;
                ...
                function Ct(e, t) {
                    ...
                    if (t.start_key && (t.startkey = t.start_key), t.end_key && (t.endkey = t.end_key), "undefined" != typeof t.startkey && (c.startkey = bo(t.descending ? [t.startkey, {}] : [t.startkey])), "undefined" != typeof t.endkey) {
                        var f = t.inclusive_end !== !1;
                        t.descending && (f = !f), c.endkey = bo(f ? [t.endkey, {}] : [t.endkey])
                    }
                ...
                function Rt(e, t, r) {
                    if ("http" === e.type()) return bt(e, t, r);
                    if ("function" == typeof e._query) return wt(e, t, r);
                    if ("string" != typeof t) {
                        gt(r, t);
                        var o = {
                            db: e,
                    ...
                    return e.get("_design/" + s).then(function(t) {
                        ...
                        if (!o || "string" != typeof o.map) throw new Nt("ddoc " + s + " has no view named " + u);
                        gt(r, o);
                        var a = {
                            db: e,
                            viewName: i,
                                ...
                                if (n.length) {
                                    ...
                                    e.executeSql(o, a, function(e) {
                                        ...
                                        e.executeSql(t, n, function(e, t) {
                                            for (var r = new Xn.Set, o = 0; o < t.rows.length; o++) r.add(t.rows.item(o).digest);
                                            n.forEach(function(t) {
                                                r.has(t) || (e.executeSql("DELETE FROM " + Po + " WHERE digest=?", [t]), e.executeSql("DELETE FROM " + Fo + " WHERE digest=?", [t]))
                                            })
                                        })
                                    })
                                }
                    ...
                    if (e.length) {
                        ...
                        e.forEach(function(e) {
                            ...
                            n.executeSql(o, [t, e], function(e, t) {
                                ...
                                a.push(n), e.executeSql("DELETE FROM " + Bo + " WHERE seq=?", [n], r)
                            })
                        })
                    }
                }
                ...
                function vn(e, t, n) {
                    ...
                    for (var s = 0, u = e.length; u > s; s++) {
                        var c = e[s];
                        if (c.pos === t.pos && c.ids[0] === t.ids[0]) r = pn(c.ids, t.ids), o.push({
                            pos: c.pos,
                            ids: r.tree
                        }), i = i || r.conflicts, a = !0;
                        else if (n !== !0) {
                            ...
                            for (p.push({
                                ...
                                var v = p.pop();
                                if (0 !== v.diff)
                                    for (var y = v.ids[2], _ = 0, m = y.length; m > _; _++) p.push({
                                        ids: y[_],
                                        diff: v.diff - 1,
                                        parent: v.ids,
                                        parentIdx: _
                ...
                function yn(e, t) {
                    for (var n, r = H(e), o = 0, i = r.length; i > o; o++) {
                        var a = r[o],
                            s = a.ids,
                ...
                function mn(e, t) {
                    for (var n, r = e.slice(), o = t.split("-"), i = parseInt(o[0], 10), a = o[1]; n = r.pop();) {
                        ...
                        for (var s = n.ids[2], u = 0, c = s.length; c > u; u++) r.push({
                            pos: n.pos + 1,
                            ids: s[u]
                        })
                    }
                ...
                function gn(e, t, n, r, o, i, a, s) {
                    if (mn(t.rev_tree, n.metadata.rev)) return r[o] = n, i();
                ...
                function wn(e, t, n, r, o, i, a, s, u) {
                    function c(e, t, n) {
                        var r = A(e.metadata),
                            o = O(e.metadata, r);
                        if ("was_delete" in s && o) return i[t] = d(ur, "deleted"), n();
                        var u = l && bn(e);
                        if (u) {
                            var c = d(cr);
                            return i[t] = c, n()
                    ...
                    t.forEach(function(e, t) {
                        ...
                        var a = e.metadata.id;
                        h.has(a) ? (v--, h.get(a).push([e, t])) : h.set(a, [
                            [e, t]
                        ])
                        ...
                        function s() {
                            var s = t[u],
                                f = s[0],
                                d = s[1];
                            if (r.has(n)) gn(e, r.get(n), f, i, d, o, a, l);
                            else {
                ...
                function Sn(e, t, n, r, o, i, a) {
                    ...
                    function f(e, t, n, o, i, a, s, u) {
                        function c() {
                            ...
                            g.executeSql(u, c, function(e, n) {
                                ...
                                return g.executeSql(e, [i, a], function(e, n) {
                    ...
                    function h(e) {
                        ...
                        _.forEach(function(e) {
                            if (e._id && P(e._id)) return t();
                            var n = e.metadata.id;
                            g.executeSql("SELECT json FROM " + No + " WHERE id = ?", [n], function(e, r) {
                                if (r.rows.length) {
                    ...
                    function p(e, t, n) {
                        ...
                        g.executeSql(r, [e], function(o, i) {
                            return i.rows.length ? n() : (r = "INSERT INTO " + Fo + " (digest, body, escaped) VALUES (?,?,1)", void o.executeSql(r, [e, Mt(t)], function() {
                                n()
                            }, function() {
                                return n(), !1
                            }))
                    ...
                    if (m.length) return a(m[0]);
                    var g, b, w = new Array(_.length),
                        E = new Xn.Map;
                ...
                function kn(e, t, n, r, o) {
                    ...
                    function a(e, o) {
                        ...
                        n._getAttachment(a, s, function(t, n) {
                            e._attachments[o] = Kn.extend(k(a, ["digest", "content_type"]), {
                                data: n
                            }), i()
                        })
                    }
                ...
                function qn(e, t) {
                        ...
                        e.executeSql(n, [], function() {
                            ...
                            e.executeSql(n, [], function(e, n) {
                                function r() {
                                    ...
                                    e.executeSql("INSERT INTO " + Mo + " (id, rev, json) VALUES (?,?,?)", [n.id, i, n.data], function(e) {
                                        e.executeSql("DELETE FROM " + No + " WHERE id=?", [n.id], function(e) {
                                            e.executeSql("DELETE FROM " + Bo + " WHERE seq=?", [n.seq], function() {
                                                r()
                                            })
                                        })
                                    })
                    ...
                    function a(e, t) {
                        function n(e) {
                            ...
                            e.executeSql(n, [], function(e, n) {
                                function r() {
                                    var n = Jt(Qo + ", " + No + ".id AS id", [No, Bo], zo, null, No + ".id ");
                                    n += " LIMIT " + a + " OFFSET " + i, i += a, e.executeSql(n, [], function(e, n) {
                                        ...
                                        for (var i = {}, a = 0; a < n.rows.length; a++)
                                            for (var s = n.rows.item(a), u = Ht(s.data, s.id, s.rev), c = Object.keys(u._attachments || {}), f = 0; f < c.length; f++) {
                    ...
                    function v(e, t) {
                        if (-1 !== m._docCount) return t(m._docCount);
                        var n = Jt("COUNT(" + No + ".id) AS 'num'", [No, Bo], zo, Bo + ".deleted=0");
                        e.executeSql(n, [], function(e, n) {
                    ...
                    if (S.error) return Gt(t)(S.error);
                    var k = S.db;
                    "function" != typeof k.readTransaction && (k.readTransaction = k.transaction), h(), m.type = function() {
                        ...
                        var o, i, a, s = t.ctx;
                        if (!s) return k.readTransaction(function(r) {
                            m._get(e, Kn.extend({
                                ctx: r
                            }, t), n)
                        });
                        var u, c;
                        t.rev ? (u = Jt(Qo, [No, Bo], No + ".id=" + Bo + ".doc_id", [Bo + ".doc_id=?", Bo + ".rev=?"]), c = [e, t.rev]) : (u = Jt(Qo, [No, Bo], zo, No + ".id=?"), c = [e]), s.executeSql(u, c, function(e, n) {
                            if (!n.rows.length) return a = d(ur, "missing"), r();
                            var s = n.rows.item(0);
                        ...
                        "ok" !== e.deleted && d.push(Bo + ".deleted = 0"), k.readTransaction(function(t) {
                            v(t, function(o) {
                                if (n = o, 0 !== u) {
                                    var i = Jt(Qo, [No, Bo], zo, d, No + ".id " + (s ? "DESC" : "ASC"));
                        ...
                        function t() {
                            ...
                            k.readTransaction(function(t) {
                                t.executeSql(d, f, function(t, n) {
                                    ...
                                    for (var u = 0, c = n.rows.length; c > u; u++) {
                                        var f = n.rows.item(u),
                                            l = an(f.metadata);
                                        p = f.maxSeq;
                                        ...
                                        if (y && (s++, i && a.push(v), e.attachments && e.include_docs ? kn(d, e, m, t, r(v)) : r(v)()), s === o) break
                                    }
                                })
                        ...
                        function r(e) {
                            var r, c;
                            i ? (r = "UPDATE " + Mo + " SET rev=?, json=? WHERE id=? AND rev=?", c = [o, u, a, i]) : (r = "INSERT INTO " + Mo + " (id, rev, json) VALUES (?,?,?)", c = [a, o, u]), e.executeSql(r, c, function(e, r) {
                                r.rowsAffected ? (s = {
                                    ok: !0,
                                    id: a,
                                    rev: o
                ...
                function An() {
                    if (!ai.running && ai.queue.length) {
                        ...
                        e.action(function(t, r) {
                            xn(e.callback, this, [t, r]), ai.running = !1, n.nextTick(An)
                        })
                    }
                }
                            ...
                            return or.all(n.map(function(n) {
                                ...
                                if ("body" in r) {
                                    ...
                                    return new or(function(a) {
                                        Ln(o, i, t, function(t) {
                                            e.doc._attachments[n] = Kn.extend(k(r, ["digest", "content_type"]), {
                                                data: t
                                            }), a()
                                        })
                                    })
                ...
                function Bn(e, t, n, r, o, i, a) {
                    ...
                    function c() {
                        ...
                        if (x.length)
                            for (var n = 0, r = 0, o = x.length; o > r; r++) {
                                var i = x[r];
                                if (i._id && P(i._id)) e();
                                else {
                    ...
                    for (var b, w, E, S, k, q, x = t.docs, A = 0, T = 0, O = x.length; O > T; T++) {
                        var j = x[T];
                    ...
                    function o(e, r) {
                        ...
                        function i(t, n, r) {
                            var i = {
                                ...
                                a = r.deleted;
                            if ("ok" === e.deleted) k.push(i), a ? (i.value.deleted = !0, i.doc = null) : e.include_docs && o(r, i, n);
                            else if (!a && d-- <= 0 && (k.push(i), e.include_docs && o(r, i, n), 0 === --h)) return;
                            t["continue"]()
                        }
                        ...
                        var c = "startkey" in e ? e.startkey : !1,
                            ...
                            y = Fn(c, f, p, l, v);
                        if (y && y.error) return Mn(t, e, y.error, r);
                        var _ = [Zo, ei];
                ...
                function Wn(e, t, r) {
                    ...
                    e._meta = null, e.type = function() {
                        ...
                        var o, i, a, s = t.ctx;
                        if (!s) {
                            var u = Nn(h, [Zo, ei, ti], "readonly");
                            if (u.error) return n(u.error);
                            s = u.txn
                        }
                        s.objectStore(Zo).get(e).onsuccess = function(e) {
                            if (i = jn(e.target.result), !i) return a = d(ur, "missing"), r();
                            if (O(i) && !t.rev) return a = d(ur, "deleted"), r();
                        ...
                        function n(e) {
                            ...
                            var i = Cn(e.value),
                                a = e.key;
                            if (s && !s.has(i._id)) return e["continue"]();
                            var l;
                    ...
                    var p = si[l];
                    if (p) return h = p.idb, e._meta = p.global, void n.nextTick(function() {
                        r(null, e)
                    });
                    var v;
                    v = t.storage ? Jn(l, t.storage) : indexedDB.open(l, Yo), "openReqList" in Hn || (Hn.openReqList = {}), Hn.openReqList[l] = v, v.onupgradeneeded = function(e) {
                        ...
                        var n = h.transaction([ri, ii, Zo], "readwrite"),
                ...
                Vn(F, zn.EventEmitter), F.prototype.cancel = function() {
                    ...
                    var t = this,
                        n = e.complete;
                    if (e = _(e), "live" in e && !("continuous" in e) && (e.continuous = e.live), e.processChange = M, "latest" === e.since && (e.since = "now"), e.since || (e.since = 0), "now" === e.since) return void this.db.info().then(function(r) {
                    ...
                    if (e.continuous && "now" !== e.since && this.db.info().then(function(e) {
                        ...
                        }), e.filter && "string" == typeof e.filter && ("_view" === e.filter ? e.view = I(e.view) : e.filter = I(e.filter), "http" !== this.db.type() && !e.doc_ids)) return this.filterChanges(e);
                ...
                var Rr = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),
                    Dr = K(["_id", "_rev", "_attachments", "_deleted", "_revisions", "_revs_info", "_conflicts", "_deleted_conflicts", "_local_seq", "_rev_tree", "_replication_id", "_replication_state", "_replication_state_time", "_replication_state_reason", "_replication_stats", "_removed"]),
                    Nr = K(["_attachments", "_replication_id", "_replication_state", "_replication_state_time", "_replication_state_reason", "_replication_stats"]);
                Vn(ie, zn.EventEmitter), ie.prototype.post = S("post", function(e, t, n) {
                    ...
                    var t, n, r, o, i = e.shift(),
                        a = "_id" in i;
                    if ("object" != typeof i || Array.isArray(i)) return (o = e.pop())(d(br));
                    for (;;)
                        if (t = e.shift(), n = typeof t, "string" !== n || a ? "string" !== n || !a || "_rev" in i ? "object" === n ? r = t : "function" === n && (o = t) : i._rev = t : (i._id = t, a = !0), !e.length) break;
                    ...
                    return "function" == typeof o && (i = o, o = r, r = n, n = null), "undefined" == typeof o && (o = r, r = n, n = null), s.get(e).then(function(e) {
                        if (e._rev !== n) throw d(cr);
                        return a(e)
                    }, function(t) {
                        if (t.reason === ur.message) return a({
                            _id: e
                        });
                        throw t
                    })
                    ...
                    if ("function" == typeof t && (n = t, t = {}), "string" != typeof e) return n(d(fr));
                    if (P(e) && "function" == typeof this._getLocal) return this._getLocal(e, n);
                    var o = [],
                        i = this;
                    ...
                    if ("all" === t.open_revs) this._getRevisionTree(e, function(e, t) {
                        ...
                        if (!Array.isArray(t.open_revs)) return n(d(pr, "function_clause"));
                        o = t.open_revs;
                        for (var a = 0; a < o.length; a++) {
                            var s = o[a];
                            if ("string" != typeof s || !/^\d+-/.test(s)) return n(d(xr))
                        }
                        r()
                    }
                    ...
                    if ("function" == typeof e && (t = e, e = {}), e.skip = "undefined" != typeof e.skip ? e.skip : 0, e.start_key && (e.startkey = e.start_key), e.end_key && (e.endkey = e.end_key), "keys" in e) {
                        ...
                        if (n) return void t(d(_r, "Query parameter `" + n + "` is not compatible with multi-get"));
                        if ("http" !== this.type()) return ne(this, e, t)
                    }
                    ...
                    if ("function" == typeof t && (n = t, t = {}), t = t || {}, Array.isArray(e) && (e = {
                            docs: e
                        }), !e || !e.docs || !Array.isArray(e.docs)) return n(d(sr));
                    for (var r = 0; r < e.docs.length; ++r)
                        if ("object" != typeof e.docs[r] || Array.isArray(e.docs[r])) return n(d(br));
                    var o;
                ...
                de(ce), ce.parseAdapter = function(e, t) {
                    ...
                    if (o) {
                        if (e = /http(s?)/.test(o[1]) ? o[1] + "://" + o[2] : o[2], n = o[1], !ce.adapters[n].valid()) throw "Invalid adapter";
                        return {
                            name: e,
                            adapter: o[1]
                        }
                    ...
                    if (t.adapter) r = t.adapter;
                        ...
                        for (var a = 0; a < ce.preferredAdapters.length; ++a)
                            if (r = ce.preferredAdapters[a], r in ce.adapters) {
                                if (i && "idb" === r) {
                ...
                var Ur = function(e) {
                    ...
                    Hr = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"],
                    Wr = "queryKey",
                    Jr = /(?:^|&)([^&=]*)=?([^&]*)/g,
                    Kr = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
                    Gr = Gn.extend,
                ...
                be.prototype.getCheckpoint = function() {
                    ...
                    return e.target.get(e.id).then(function(t) {
                        return e.src.get(e.id).then(function(e) {
                            if (t.version !== e.version) return Yr;
                            var n;
                ...
                Vn(Zt, zn.EventEmitter), Zt.prototype.addListener = function(e, t, n, r) {
                    function o() {
                        ...
                        if (i._listeners[t]) {
                            ...
                            a = !0;
                            var s = k(r, ["style", "include_docs", "attachments", "conflicts", "filter", "doc_ids", "view", "since", "query_params", "binary"]);
